...
namespace ArcheryStats.Core
{
    ...
    where TEntity : class, IEntity
    {
        ...
        protected ArcheryStatsContext ArcheryStatsContext { get; private set; }

        public Repository(ArcheryStatsContext context)
        {
            ArcheryStatsContext = context;
            DbSet = ArcheryStatsContext.Set<TEntity>();
        }
        ...
        public virtual void Insert(TEntity entity)
        {
            ...
            else
            {
                ...
                ArcheryStatsContext.Entry(entity).State = EntityState.Modified;
            }
        ...
        private void SaveChange()
        {
            ...
            ArcheryStatsContext.SaveChanges();
        }
    }
}
